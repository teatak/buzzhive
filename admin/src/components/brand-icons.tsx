...
export function MimoIcon({ className }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M41.488 16.639 37.325 16.639C37.147 16.639 37.002 16.78 37.002 16.955L37.002 35.95C37.002 36.123 37.147 36.265 37.325 36.265L41.488 36.265C41.665 36.265 41.811 36.123 41.811 35.95L41.811 16.955C41.811 16.78 41.665 16.639 41.488 16.639"
        fill="currentColor"
      />
      <path
        d="M27.274 16.639 11.417 16.639C11.238 16.639 11.095 16.78 11.095 16.955L11.095 35.95C11.095 36.123 11.238 36.265 11.417 36.265L15.581 36.265C15.758 36.265 15.905 36.123 15.905 35.95L15.905 21.042C15.905 20.87 16.048 20.727 16.226 20.727L25.196 20.727C27.718 20.727 28.434 22.659 28.434 23.905L28.434 35.95C28.434 36.123 28.579 36.265 28.757 36.265L32.919 36.265C33.096 36.265 33.241 36.123 33.241 35.95L33.241 22.475C33.241 21.363 33.107 19.765 31.673 18.358C30.173 16.89 28.804 16.639 27.274 16.639"
        fill="currentColor"
      />
      <path
        d="M24.357 24.204 19.986 24.204C19.807 24.204 19.661 24.346 19.661 24.52L19.661 35.952C19.661 36.124 19.807 36.266 19.986 36.266L24.357 36.266C24.534 36.266 24.679 36.124 24.679 35.952L24.679 24.52C24.679 24.346 24.534 24.204 24.357 24.204"
        fill="currentColor"
      />
    </svg>
  );
...
export function MoonshotIcon({ className }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M6.15 5.6h1.8c.18 0 .33.15.33.34v5.03c0 .28.34.42.54.23l5.7-5.5c.06-.06.15-.1.24-.1h2.86c.29 0 .43.35.22.54l-5.24 4.96c-.17.16-.16.44.03.58l4.2 3.05c.58.42 1.2.68 1.9.78.16.02.27.16.27.32v2.36c0 .2-.17.35-.37.33a6.85 6.85 0 0 1-3.04-1.12l-4.69-3.43a.36.36 0 0 0-.47.04l-1.98 1.92a.37.37 0 0 0-.11.26v2.58c0 .18-.15.33-.33.33H6.15a.33.33 0 0 1-.33-.33V5.94c0-.19.15-.34.33-.34z"
        fill="currentColor"
      />
    </svg>
  );
...
export function ZhipuIcon({ className }: { className?: string }) {
  return (
    ...
    >
      <path
        d="m15.47 7.1-1.3 1.85c-.2.29-.54.47-.9.47h-7.1V7.09c-.01.01 9.3.01 9.3.01z"
        fill="currentColor"
      />
      <path d="M24.3 7.1 13.14 22.91H5.7L16.86 7.1z" fill="currentColor" />
      <path
        d="m14.53 22.91 1.31-1.86c.2-.29.54-.47.9-.47h7.09v2.33z"
        fill="currentColor"
      />
    </svg>
  );
...
export function BuzzHiveIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M32 8.48 52.33 20.24v23.52L32 55.52 11.67 43.76V20.24L32 8.48Z" fill="none" stroke="currentColor" strokeWidth="2.85" strokeLinejoin="round" />
      <path
      ...
      />
      <path d="M26.54 30.32a5.46 5.46 0 0 1 10.92 0v9.24a5.46 5.46 0 0 1-10.92 0V30.32Z" fill="none" stroke="currentColor" strokeWidth="2.85" strokeLinejoin="round" />
      <path d="M26.54 33.85h10.92v4.45H26.54Z" fill="currentColor" />
      <path d="M26.96 33.85h10.08M26.96 38.3h10.08" fill="none" stroke="currentColor" strokeWidth="2.52" strokeLinecap="round" />
      <path
