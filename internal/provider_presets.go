...
func providerPresets() []ProviderPreset {
	return []ProviderPreset{
		...
		{ID: "openai", Name: "OpenAI", Type: providerOpenAI, BaseURL: "https://api.openai.com/v1", SupportsResponses: true, Description: "OpenAI official API."},
		...
		{ID: "openrouter", Name: "OpenRouter", Type: providerOpenAICompatible, BaseURL: "https://openrouter.ai/api/v1", SupportsResponses: true, Description: "OpenRouter OpenAI-compatible router."},
	}
}
