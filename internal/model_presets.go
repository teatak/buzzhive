...
func modelPresets() []ModelPreset {
	...
	return []ModelPreset{
		{ID: "gemini-3.5-flash", Family: "Gemini", Name: "gemini-3.5-flash", DisplayName: "Gemini 3.5 Flash", Description: "Google fast multimodal model.", ContextWindow: 1050000, MaxInputTokens: 1050000, MaxOutputTokens: 64000, Capabilities: capMultimodal, SelectionPolicy: "round_robin"},
		{ID: "gemini-3.1-pro", Family: "Gemini", Name: "gemini-3.1-pro", DisplayName: "Gemini 3.1 Pro", Description: "Google pro multimodal model.", ContextWindow: 1050000, MaxInputTokens: 1050000, MaxOutputTokens: 64000, Capabilities: capMultimodal, SelectionPolicy: "round_robin"},

		{ID: "gpt-5.6-sol", Family: "OpenAI", Name: "gpt-5.6-sol", DisplayName: "GPT 5.6 Sol", Description: "OpenAI multimodal model.", ContextWindow: 1050000, MaxInputTokens: 1050000, MaxOutputTokens: 128000, Capabilities: capMultimodal, SelectionPolicy: "round_robin"},
		{ID: "gpt-5.6-terra", Family: "OpenAI", Name: "gpt-5.6-terra", DisplayName: "GPT 5.6 Terra", Description: "OpenAI multimodal model.", ContextWindow: 1050000, MaxInputTokens: 1050000, MaxOutputTokens: 128000, Capabilities: capMultimodal, SelectionPolicy: "round_robin"},
		{ID: "gpt-5.6-luna", Family: "OpenAI", Name: "gpt-5.6-luna", DisplayName: "GPT 5.6 Luna", Description: "OpenAI multimodal model.", ContextWindow: 1050000, MaxInputTokens: 1050000, MaxOutputTokens: 128000, Capabilities: capMultimodal, SelectionPolicy: "round_robin"},
		{ID: "gpt-5.5", Family: "OpenAI", Name: "gpt-5.5", DisplayName: "GPT 5.5", Description: "OpenAI multimodal model.", ContextWindow: 1000000, MaxInputTokens: 1000000, MaxOutputTokens: 128000, Capabilities: capMultimodal, SelectionPolicy: "round_robin"},
		{ID: "gpt-5.4", Family: "OpenAI", Name: "gpt-5.4", DisplayName: "GPT 5.4", Description: "OpenAI multimodal model.", ContextWindow: 1000000, MaxInputTokens: 1000000, MaxOutputTokens: 128000, Capabilities: capMultimodal, SelectionPolicy: "round_robin"},
		...
		{ID: "claude-fable-5", Family: "Anthropic", Name: "claude-fable-5", DisplayName: "Claude Fable 5", Description: "Anthropic fable model.", ContextWindow: 1000000, MaxInputTokens: 1000000, MaxOutputTokens: 128000, Capabilities: capVision, SelectionPolicy: "round_robin"},
		...
		{ID: "qwen3.7-plus", Family: "Qwen", Name: "qwen3.7-plus", DisplayName: "Qwen 3.7 Plus", Description: "Qwen multimodal model.", ContextWindow: 1000000, MaxInputTokens: 1000000, MaxOutputTokens: 65536, Capabilities: capMultimodal, SelectionPolicy: "round_robin"},
		{ID: "kimi-k3", Family: "Moonshot", Name: "kimi-k3", DisplayName: "Kimi K3", Description: "Kimi vision model.", ContextWindow: 1000000, MaxInputTokens: 1000000, MaxOutputTokens: 128000, Capabilities: capVision, SelectionPolicy: "round_robin"},
